...
class CropWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        #set the central widget to the display
    ...
    def create_select_crop_layout(self):
        #select crop type
        self.crop_radio_button = RadioButtonWidget("Crop simulation","Please select a crop",("Wheat","Potato"))
        self.instantiate_button = QPushButton("Create crop")

        #create layout to hold the widgets
        self.initial_layout = QVBoxLayout()
        self.initial_layout.addWidget(self.crop_radio_button)
    ...
    def create_view_crop_layout(self,crop_type):
        ...
        #add widget/layout to grow layout
    ...
    def instantiate_crop(self):
        crop_type = self.crop_radio_button.selected_button()
        if crop_type == 1:
